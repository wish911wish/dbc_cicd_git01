...
The 'cc_git_abc_pipeline_bundle' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/cc_git_abc_pipeline_bundle/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] cc_git_abc_pipeline_bundle_etl` to your workspace.
